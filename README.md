...
Solution: Some of the labels are not exact; keep trying to click around where you think they are. The clock provides the time 06:13, which is the code for the box. The box gives you a lighter which can be placed in the fireplace. The fireplace gives you a doorknob, which can be used for the drawer without a knob. The drawer has a remote which can turn on the Tv. The Tv gives you a random code each time you play.
